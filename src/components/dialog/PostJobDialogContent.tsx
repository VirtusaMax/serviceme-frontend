    ...
    <DialogContent className="bg-gradient-to-br from-custom-blue to-custom-blue text-white p-8 rounded-2xl shadow-2xl max-w-md mx-auto">
      ...
      <form className="space-y-5">
        ...
        <div className="flex justify-between items-center space-x-4">
          <button
            type="button"
            className="w-1/2 px-4 py-2 bg-white text-custom-blue font-semibold rounded-xl shadow-md transition duration-300 ease-in-out hover:bg-custom-yellow hover:text-black hover:shadow-lg"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="w-1/2 px-4 py-2 bg-custom-yellow text-black font-semibold rounded-xl shadow-md transition duration-300 ease-in-out hover:bg-custom-yellow hover:text-black hover:shadow-lg"
          >
            Post
          </button>
        </div>
