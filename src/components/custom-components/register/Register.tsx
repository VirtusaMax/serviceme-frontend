...
const Register: React.FC<RegisterProps> = ({ profiles }) => {
  return (
    <div className="mt-20 relative isolate overflow-hidden bg-gradient-to-br from-custom-blue via-custom-blue to-custom-yellow py-16 sm:py-20 px-6 sm:px-10 md:px-12 lg:px-20">
