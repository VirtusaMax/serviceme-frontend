         ...
         key={i}
          className="relative bg-gray-100 shadow-md rounded-xl p-4 border border-gray-200 hover:shadow-lg transition duration-300 flex flex-col h-auto sm:h-[300px] md:h-[300px] lg:h-[300px] overflow-hidden"
           >
            ...
            <p className="text-gray-600 text-sm max-h-40 overflow-auto">{job.description}</p>

            {/* Category Selection */}
            <div className="flex flex-wrap gap-2 mt-4">
              <span className="flex items-center border rounded-full px-3 py-1 text-sm text-gray-700 border-gray-300 bg-gray-100">
                {job.category}
